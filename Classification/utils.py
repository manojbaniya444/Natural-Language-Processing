...
read_method = {'./data/atis-2.dev.w-intent.iob':get_data,
               './data/atis.train.w-intent.iob':get_data2,
               './data/atis.test.w-intent.iob':get_data,
              './data/atis-2.train.w-intent.iob':get_data2}
